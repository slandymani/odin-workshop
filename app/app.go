...
import (
	...
	"github.com/slandymani/odin-workshop/docs"
...
func New(
	...
	app.OdinworkshopKeeper = *odinworkshopmodulekeeper.NewKeeper(
		appCodec,
		keys[odinworkshopmoduletypes.StoreKey],
		keys[odinworkshopmoduletypes.MemStoreKey],
		app.GetSubspace(odinworkshopmoduletypes.ModuleName),
	)
