...
// RandomNumbersData creates the RandomNumbers packet
// data with obi encoded and send it to the channel
func (k msgServer) RandomNumbersData(goCtx context.Context, msg *types.MsgRandomNumbersData) (*types.MsgRandomNumbersDataResponse, error) {
	...
	return &types.MsgRandomNumbersDataResponse{}, nil
}
