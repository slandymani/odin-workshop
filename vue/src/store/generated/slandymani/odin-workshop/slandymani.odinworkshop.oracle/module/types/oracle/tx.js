...
const baseMsgRandomNumbersData = {
    creator: "",
    oracleScriptId: 0,
    sourceChannel: "",
    askCount: 0,
...
export const MsgRandomNumbersData = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.calldata !== undefined) {
            RandomNumbersCallData.encode(message.calldata, writer.uint32(34).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        const message = { ...baseMsgRandomNumbersData };
        message.feeLimit = [];
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.calldata = RandomNumbersCallData.decode(reader, reader.uint32());
                    break;
                case 5:
...
const baseMsgRandomNumbersDataResponse = {};
...
export class MsgClientImpl {
    ...
    RandomNumbersData(request) {
        const data = MsgRandomNumbersData.encode(request).finish();
        const promise = this.rpc.request("slandymani.odinworkshop.oracle.Msg", "RandomNumbersData", data);
        return promise.then((data) => MsgRandomNumbersDataResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
