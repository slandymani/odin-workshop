...
const baseMsgRandomNumbersData: object = {
  creator: "",
  oracleScriptId: 0,
  sourceChannel: "",
  askCount: 0,
...
export const MsgRandomNumbersData = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgRandomNumbersData {
    ...
    const message = { ...baseMsgRandomNumbersData } as MsgRandomNumbersData;
    message.feeLimit = [];
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.calldata = RandomNumbersCallData.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): MsgRandomNumbersData {
    ...
    if (object.calldata !== undefined && object.calldata !== null) {
      message.calldata = RandomNumbersCallData.fromJSON(object.calldata);
    } else {
  ...
  toJSON(message: MsgRandomNumbersData): unknown {
    ...
    message.calldata !== undefined &&
      (obj.calldata = message.calldata
        ? RandomNumbersCallData.toJSON(message.calldata)
        : undefined);
  ...
  fromPartial(object: DeepPartial<MsgRandomNumbersData>): MsgRandomNumbersData {
    ...
    if (object.calldata !== undefined && object.calldata !== null) {
      message.calldata = RandomNumbersCallData.fromPartial(object.calldata);
    } else {
      message.calldata = undefined;
    }
    if (object.askCount !== undefined && object.askCount !== null) {
...
const baseMsgRandomNumbersDataResponse: object = {};

export const MsgRandomNumbersDataResponse = {
  encode(
    _: MsgRandomNumbersDataResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    ...
    length?: number
  ): MsgRandomNumbersDataResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRandomNumbersDataResponse,
    } as MsgRandomNumbersDataResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgRandomNumbersDataResponse>
  ): MsgRandomNumbersDataResponse {
    const message = {
      ...baseMsgRandomNumbersDataResponse,
    } as MsgRandomNumbersDataResponse;
...
export interface Msg {
  ...
  RandomNumbersData(
    request: MsgRandomNumbersData
  ): Promise<MsgRandomNumbersDataResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  RandomNumbersData(
    ...
    const data = MsgRandomNumbersData.encode(request).finish();
    const promise = this.rpc.request(
      "slandymani.odinworkshop.oracle.Msg",
      "RandomNumbersData",
      data
    );
    return promise.then((data) =>
      MsgRandomNumbersDataResponse.decode(new Reader(data))
    );
  }
}
